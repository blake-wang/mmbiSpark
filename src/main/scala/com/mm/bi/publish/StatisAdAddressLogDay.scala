...
/**
  * statis_ad_address_log_day
  * Created by kequan on 3/28/18.
  */
object StatisAdAddressLogDay {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val sql_hive =
      """
        ...
        |LEFT JOIN (
        |   SELECT b.Source,b.GameId ,a.address
        ...
        |   GROUP BY b.Source, b.GameId,a.address HAVING pvcount >10
    ...
    val sql_mysql =
      """
        |insert into statis_ad_address_log_day(DayTime,GameId,Source,address,IpCount,PvCount,UvCount,windowsCount,IOSCount,AndroidCount) values(?,?,?,?,?,?,?,?,?,?)
